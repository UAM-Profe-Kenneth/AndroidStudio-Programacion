...
class ProductoAdapter(
    //Para que siempre implemente los listener de editar y eliminar
    ...
    // Es una clase interna, toma un producto y lo muestra en cada item del modelo de items producto
    // el modelo llega de parametro
